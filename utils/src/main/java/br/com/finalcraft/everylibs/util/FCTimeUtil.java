...
public class FCTimeUtil {
    ...
    /**
     * Format an epoch-millis instant using the given formatter and time zone.
     *
     * @param millis    the epoch milliseconds to format
     * @param formatter the formatter to apply
     * @param zoneId    the zone the instant is resolved against
     * @return the formatted date/time string
     */
    public static String getFormatted(long millis, DateTimeFormatter formatter, ZoneId zoneId){
    ...
    /**
     * Same as {@link #getFormatted(long, DateTimeFormatter, ZoneId)} resolving the
     * instant against the system default time zone.
     */
    public static String getFormatted(long millis, DateTimeFormatter formatter){
        return getFormatted(millis, formatter, ZoneId.systemDefault());
    }
